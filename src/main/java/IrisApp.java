...
public class IrisApp {
    public static void main(String[] args) throws Exception{
       ...
       // System.out.println(configuration.toJson());
        ...
        File fileTrain=new ClassPathResource("IrisTrain.csv").getFile();
        RecordReader recordReaderTrain=new CSVRecordReader();
        recordReaderTrain.initialize(new FileSplit(fileTrain));
        int bashSize=1;
        int classIndex=4;
        DataSetIterator dataSetIterator=new RecordReaderDataSetIterator(recordReaderTrain,bashSize,classIndex,numOut);
        ...
        DataSetIterator dataSetIteratorTest=new RecordReaderDataSetIterator(recordReaderTest,bashSize,classIndex,numOut);
